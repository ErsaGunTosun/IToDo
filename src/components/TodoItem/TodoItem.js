...
import { deleteTodo, setTodoStatus } from '../../stores/todos'

function TodoItem({ size, dateText, id, title, priority, description, todoStatus = false }) {
    const dispatch = useDispatch()
    const [finish, setFinish] = useState(todoStatus)
    ...
    const handleSelect = (e) => {
        setFinish(!finish)
        dispatch(setTodoStatus([dateText, id]));
    }
