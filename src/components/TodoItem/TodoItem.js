...
function TodoItem({size}) {
    return (
        <div className={`w-full flex ${size === "basis-2/9" ? "flex-col" : "flex-row"} items-center bg-gray-500 p-2 rounded-md`}>
            ...
            <div className='flex flex-col grow '>
                <div className='basis-full flex flex-row items-center'>
                    ...
                    <p className='ms-2 text-xl text-gray-100'>Do Homework</p>
                </div>

                <p className={`basis-full ${size === "basis-2/9" ? "hidden" : "block"}  text-base text-gray-200 ps-6`}>Lorem ipsum dolor sit amet, consectetur adipiscing.</p>
            </div>
