                        ...
                        <div className="flex space-x-2  justify-center">
                            <div className='flex'>
                                <input type="time" id="time" onChange={(e) => { handleTime(e, "start") }}
                                    className="rounded-lg text-gray-100 bg-gray-600  leading-none block flex-1 w-full text-sm p-2.5 outline-none" min="09:00" max="18:00" value={startTime} required />
                            </div>
                            <div className='flex'>
                                <input type="time" id="time" onChange={(e) => { handleTime(e, "end") }}
                                    className="rounded-lg text-gray-100 bg-gray-600 leading-none block flex-1 w-full text-sm p-2.5 outline-none" min="09:00" max="18:00" value={endTime} required />
                            </div>
                        </div>
